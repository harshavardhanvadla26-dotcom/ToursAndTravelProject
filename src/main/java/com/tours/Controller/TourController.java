...
public class TourController {
    ...
    public ResponseEntity<Tour> addTourWithImages(@RequestParam("tour") String tourJson,
        ...
        if (image1 != null && !image1.isEmpty()) {
            imageUrls.add("/upload_images/" + imageService.uploadImage(image1));
        }
        if (image2 != null && !image2.isEmpty()) {
            imageUrls.add("/upload_images/" + imageService.uploadImage(image2));
        }
        tour.setTourImages(imageUrls);
    ...
    public ResponseEntity<Void> deleteTour(@PathVariable Long id) {
        try {
            ...
            for (String imageUrl : tour.getTourImages()) {
                if (imageUrl != null && imageUrl.startsWith("/upload_images/")) {
