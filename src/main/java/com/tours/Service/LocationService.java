...
public class LocationService {
    ...
    // Get paged locations for public API
    public org.springframework.data.domain.Page<Location> getLocations(org.springframework.data.domain.Pageable pageable) {
        logger.info("Fetching paged locations: page=" + pageable.getPageNumber() + ", size=" + pageable.getPageSize());
