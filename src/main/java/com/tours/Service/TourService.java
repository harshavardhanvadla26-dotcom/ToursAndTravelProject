...
public class TourService {
    ...
    public List<Tour> getAllToursWithDetails() {
        ...
        tours.forEach(this::initializeTourCollections);
        return tours;
    }
    ...
    public Optional<Tour> getTourById(Long id) {
        ...
        Optional<Tour> tour = tourRepo.findTourByIdWithDetails(id);
        tour.ifPresent(this::initializeTourCollections);
        return tour;
    }

    private void initializeTourCollections(Tour tour) {
        tour.getMeals().size();
        tour.getActivities().size();
        tour.getTourImages().size();
    }
