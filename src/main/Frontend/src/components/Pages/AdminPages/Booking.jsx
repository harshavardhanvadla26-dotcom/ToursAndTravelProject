...
import { bookDetails, getThunkData } from "../../../Redux/API/API";
  ...
  useEffect(() => {
    const fetchTourDetails = async () => {
      try {
        ...
        const data = getThunkData(response, "Failed to fetch booking details");
        setTourDetails({
          ...data.details,
          bookings: Array.isArray(data.details?.bookings)
            ? data.details.bookings
            : [],
        });
      } catch (error) {
